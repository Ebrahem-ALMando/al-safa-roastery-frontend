...
export function useInventoryMovements(filters: InventoryMovementFilters, itemScoped = false) {
  ...
  const ready = !authLoading && isAuthenticated && (!itemScoped || Boolean(filters.item_id))
